...
contract AMMTest2 is MyERC20 {
    ...
    */
    ...
    external 
    {
        ...
        // LPtokensToBeMinted = squareRoot(amountTokenA * amountTokenB)
    ...
    */
    ...
    private
    {
        ...
        // calculate k = A * B
        uint256 k = _getLiquidityPoolSize();
        ...
        // conduct swap
            ...
            require(_getLiquidityPoolSize() >= k, "AMMtest: Error in swap function, pool size decreased");
    }

    function _getLiquidityPoolSize() 
    private
    view 
    returns (uint256)
    {
